...
local function enforceWinCondition( trigger )
  ...
  local function jointMafiaLynchWins()
    if playerinfo[lastlynched].role == "Folle" and ( lastlynched == lynchertarget and playerinfo[lyncherid].alive == 1 ) then
      jointMafiaFoolLyncherWins()
    elseif playerinfo[lastlynched].role == "Folle" then
      jointMafiaFoolWins()
    elseif lastlynched == lynchertarget and playerinfo[lyncherid].alive == 1 then
  ...
  if trigger == "lynch" then
    if lastlynched ~= -1 and ( playerinfo[lastlynched].role == "Folle" or ( lastlynched == lynchertarget and playerinfo[lyncherid].alive == 1 ) ) then --fool/lyncher wins
  ...
  local function visitCop()
    ...
    local function copInvestigate()
      ...
      local function clearInvestigate( event )
        ...
        if playerinfo[investigated].alignment == 0 or playerinfo[investigated].alignment == 2 or playerinfo[investigated].alignment == 3 then
